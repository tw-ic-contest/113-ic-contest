    ...
    always @(posedge CLK or posedge RST) begin
        ...
        if (RST) begin
            ...
            2'b10: begin//SORTING STATE: Sorting the new points 
                $display("[SORTING] points_index=%0d x=%0d y=%0d judge=%0d", i, points_sorted_x[i], points_sorted_y[i], points_judged[i]);
            ...
            2'b11: begin  //SWAPING STAGE: swap the sorted 
                ...
                if (flag == 0) begin
                    ...
                    for (int = 0; int < 13; int = int + 1) begin
                        points_sorted_x[int] <= points_swap_x[int];
                        points_sorted_y[int] <= points_swap_y[int];
                    end
                    state <= 00;
                    READ_PT <= 1;
